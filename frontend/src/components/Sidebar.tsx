...
const NAV = [
  ...
  { href: "/calendar", label: "Calendar", d: "M7 3v3M17 3v3M4 9h16M5 6h14a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1Z" },
  ...
  { href: "/knowledge", label: "Study", d: "M12 3l2.5 5.5L20 11l-5.5 2.5L12 19l-2.5-5.5L4 11l5.5-2.5L12 3Z" },
  { href: "/analytics", label: "Analytics", d: "M4 20V4M4 20h16M8 16v-4M12 16V8M16 16v-6" },
  { href: "/settings", label: "Settings", d: "M10.3 3.6a1.7 1.7 0 0 1 3.4 0l.1.6a1.7 1.7 0 0 0 2.5 1.1l.5-.3a1.7 1.7 0 0 1 2.3 2.3l-.3.5a1.7 1.7 0 0 0 1.1 2.5l.6.1a1.7 1.7 0 0 1 0 3.4l-.6.1a1.7 1.7 0 0 0-1.1 2.5l.3.5a1.7 1.7 0 0 1-2.3 2.3l-.5-.3a1.7 1.7 0 0 0-2.5 1.1l-.1.6a1.7 1.7 0 0 1-3.4 0l-.1-.6a1.7 1.7 0 0 0-2.5-1.1l-.5.3a1.7 1.7 0 0 1-2.3-2.3l.3-.5a1.7 1.7 0 0 0-1.1-2.5l-.6-.1a1.7 1.7 0 0 1 0-3.4l.6-.1a1.7 1.7 0 0 0 1.1-2.5l-.3-.5a1.7 1.7 0 0 1 2.3-2.3l.5.3a1.7 1.7 0 0 0 2.5-1.1l.1-.6ZM12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" },
];
