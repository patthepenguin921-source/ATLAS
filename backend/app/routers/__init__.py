...
from app.routers import agents, analytics, dashboard, documents, knowledge, reviews, search
...
_CRUD = [
    ...
    make_crud_router(table="courses", prefix="/courses", tag="courses",
                     writable={"term_id", "teacher_id", "name", "code", "subject", "is_ap",
                               "is_honors", "credit_hours", "color", "period", "room",
